...
export const translations = {
  ko: {
    ...
    dash_step2: "사용자 이름과 동일한 이름의 저장소를 편집하거나 생성합니다.",
    ...
    guide_fullness: "포만감",
    guide_fullness_desc: "시간당 0.4점씩 감소합니다. 커밋을 푸시하여 먹이를 주세요.",
    guide_happiness: "행복도",
  ...
  en: {
    ...
    dash_step2: "Edit or create a repository named exactly like your username.",
    ...
    guide_fullness_desc: "Decreases by 0.4 pts/hour. Feed it by pushing commits.",
